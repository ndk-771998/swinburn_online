...
@include('includes.banner', ['title' => $category->name, 'banner_image' => $category->thumbnail])

<div class="container-fluid questions-list-container">

    @include('includes.breadcrumb', ['breadcrumb' => [getOption('faqs-banner-title') => '/faqs', '#' => $category->name]])
                    ...
                    <div class="questions-wrap">
                        ...
                        <div class="list-questions">
                            ...
                            <div class="sub-question">
                                <img class="lazyload" data-src="{{$faqs_category->thumbnail}}" width="233" alt="{{$faqs_category->name}}">
        ...
        <div class="questions-list-wrap">
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="detail-questions">
                        <div class="item-question">
                            <h3>{{__('faqs.question-about')}} {{$category->name}}</h3>
                            <a href="">
                                {{__('faqs.watch-all')}}
                            </a>
                            ...
                            <div class="sub-question">
                                ...
                                <div class="answer">
                                    ...
                                    <div class="links">
                                        ...
                                        <div class="icon">
                                            <div class="logo">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{$url_canonical}}&amp;src=sdkpreparse" target="_blank"><img src="{{url('assets/logos/facebook_around.svg')}}" width="16" height="16" alt=""></a>
                                            </div>
                                            <div class="zalo-share-button logo" data-href="" data-oaid="579745863508352884" data-layout="2" data-color="white" data-customize="false" style="border-radius: 50%;"></div>
                                            <div class="logo">
                                                <a href="https://www.tiktok.com/" target="_blank"><img src="{{url('assets/logos/tiktok.svg')}}" width="16" height="16" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
